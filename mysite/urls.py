...
from smp.views import getDoc,ViewPaper,addauthor,change,addzlau,delezhuanli,addzlau2,addzzau2,delezhuanzhu,addzzau,changezl,changezz
from smp.views import register,Search,dele,login_view,showp,changeau,delau,sta,logout_view, Price, prizeshow,prizedele,changeprize,SearchP,addzlauthor,addzl,viewzhuanli,addzzauthor,addzz,viewzhuanzhu
from smp.views import addprau2,addprau,addprauthor
admin.autodiscover()
urlpatterns = [
    ...
    url(r'^addzlau/$', addzlau),
    url(r'^delezhuanli/$', delezhuanli),
    url(r'^addzlau2/$', addzlau2),
    url(r'^addzzaf/$', addzzauthor),
    url(r'^addzz/$', addzz),
    url(r'^viewzz/$', viewzhuanzhu),
    url(r'^addzzau/$', addzzau),
    url(r'^addprau/$', addprau),
    url(r'^delezhuanzhu/$', delezhuanzhu),
    url(r'^addzzau2/$', addzzau2),
    url(r'^addprau2/$', addprau2),
